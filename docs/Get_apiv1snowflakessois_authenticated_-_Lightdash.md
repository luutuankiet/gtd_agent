# Get apiv1snowflakessois authenticated - Lightdash

**Source:** https://docs.lightdash.com/api-reference/projects/get-apiv1snowflakessois-authenticated
...
results
any
IntroductionGet apiv1projects validate
Assistant
