# Get apiv1saved version - Lightdash

**Source:** https://docs.lightdash.com/api-reference/charts/get-apiv1saved-version
...
required
Available options: 
Get apiv1saved historyPost apiv1saved version results
Assistant
