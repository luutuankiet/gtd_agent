# Get apiv1bigqueryssois authenticated - Lightdash

**Source:** https://docs.lightdash.com/api-reference/projects/get-apiv1bigqueryssois-authenticated
...
results
any
Get apiv1bigqueryssodatasetsGet apiv1user
Assistant
