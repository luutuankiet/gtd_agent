# Get apiv1saved promotediff - Lightdash

**Source:** https://docs.lightdash.com/api-reference/charts/get-apiv1saved-promotediff
...
required
Available options: 
Post apiv1saved promotePost apiv1saved downloadcsv
Assistant
