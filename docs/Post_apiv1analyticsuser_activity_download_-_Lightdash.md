# Post apiv1analyticsuser activity download - Lightdash

**Source:** https://docs.lightdash.com/api-reference/projects/post-apiv1analyticsuser-activity-download
...
string
required
Get apiv1analyticsuser activityGet apiv1projects spaces
Assistant
