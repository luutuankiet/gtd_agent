# Patch apiv1projects user credentials - Lightdash

**Source:** https://docs.lightdash.com/api-reference/projects/patch-apiv1projects-user-credentials
...
results
any
Get apiv1projects user credentialsGet apiv1projects custom metrics
Assistant
